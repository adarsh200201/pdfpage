...
const ImgFooter = () => {
  ...
  // Popular image tools data
  const popularTools = [
    { name: "Compress Image", icon: Download, href: "/img/compress" },
    { name: "Resize Image", icon: Move, href: "/img/resize" },
    { name: "Crop Image", icon: Crop, href: "/img/crop" },
    { name: "Rotate Image", icon: RotateCw, href: "/img/rotate" },
    { name: "Remove Background", icon: Scissors, href: "/img/remove-bg" },
  ];
                  ...
                  >
                    ...
                    <div>
                      <span className="font-bold text-xl text-white">
                        Img<span className="text-blue-400">Page</span>
                      </span>
                    </div>
                  </Link>

                  <p className="text-gray-300 mb-4 text-sm leading-relaxed">
                    Professional image editing tools for everyone. Fast, secure,
                    and privacy-focused image processing in your browser.
                  </p>
                  ...
                  <div className="space-y-2">
                    {popularTools.map((tool) => (
                      <Link
                        key={tool.name}
                        to={tool.href}
                        className="flex items-center gap-2 text-sm text-gray-300 hover:text-blue-400 transition-all duration-200 group"
                      >
                        <tool.icon className="h-4 w-4 text-blue-400 group-hover:scale-110 transition-transform" />
                  ...
                  <div className="space-y-2">
                    {support.map((link) => (
                      <Link
                        key={link.name}
                        to={link.href}
                        className="block text-sm text-gray-300 hover:text-blue-400 transition-colors duration-200 hover:translate-x-1 transform"
                      >
                        {link.name}
                      </Link>
                    ))}
