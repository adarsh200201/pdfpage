...
<a name='L57'></a><a href='#L57'>57</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">6x</span>
...
<span class="cline-any cline-yes">10x</span>
<span class="cline-any cline-yes">6x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { UrlWithStringQuery } from 'url';
&nbsp;
...
&nbsp;
  if (pathOnly) {
    ...
    u = new URL(url);
    out.href = u.href;
    out.port = u.port === '' ? <span class="branch-0 cbranch-no" title="branch not covered" >null <span class="branch-0 cbranch-no" title="branch not covered" >: u.port;</span></span>
    out.hash = u.hash === '' ? <span class="branch-0 cbranch-no" title="branch not covered" >null <span class="branch-0 cbranch-no" title="branch not covered" >: u.hash;</span></span>
    out.host = u.host;
